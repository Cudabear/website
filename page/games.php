<div id="right">
    ...
    <p id="games-disclaimer">
        Unfortunately, at this time none of my games have support for mobile.  If you're on a mobile device, you can open them but
        you won't really be able to interact with them.  Come back on a desktop to play!
    </p>

    <div id="game-link-wrap" class="center">
        ...
        <div id="ld29-block" class="game-link" name="ld29">
            <div class="game-information">
                <div><a href="/ld29">Clone Escape</a></div>
                <div class="game-genre">Stealth Platformer</div>
                <div class="game-discription-extended">This was my second venture into the world of Ludum Dare, and one of my best rated games.</div>
                <a href="https://www.youtube.com/watch?v=I0seMPcS7FM"><img title="Timelapse" class="link-logo float-right" src="res/img/youtube.png"></a>
                <a href="http://ludumdare.com/compo/ludum-dare-29/?action=preview&uid=25773"><img title="Submission Page" class="link-logo float-right" src="res/img/ld.png"></a>
                <a href="javascript:void 0;"onclick="Utils.loadPage('blog-id-154')"><img title="Postmortem" class="link-logo float-right" src="res/img/wp.png"></a>
            </div>
        </div>
        <div id="ld30-block" class="game-link" name="ld30">
            <div class="game-information">
                <div><a href="/ld30">The Bunny Theory</a></div>
                <div class="game-genre">Arcade Action Platformer</div>
                <div class="game-discription-extended">This game was my first attempt at making a stylized arcade game.  I think it's quite fun, even if it is really easy.</div>
                <a href="https://www.youtube.com/watch?v=tYIU6hruHUM" target="blank"><img title="Timelapse" class="link-logo float-right" src="res/img/youtube.png"></a>
                <a href="http://ludumdare.com/compo/ludum-dare-30/?action=preview&uid=25773"><img title="Submission Page" class="link-logo float-right" src="res/img/ld.png"></a>
            </div>
        </div>
        <div id="ld32-block" class="game-link" name="ld32">
            <div class="game-information">
                <div><a href="/ld32">Penguin Commmandos</a></div>
                <div class="game-genre">Real Time Strategy</div>
                <div class="game-discription-extended">I wanted this game to be something of a cross between an RTS and a squad-based shooter.  I wound up missing both marks.</div>
                <a href="https://www.youtube.com/watch?v=_k30iVD6g0A" target="blank"><img title="Timelapse" class="link-logo float-right" src="res/img/youtube.png"></a>
                <a href="http://ludumdare.com/compo/ludum-dare-32/?action=preview&uid=25773"><img title="Submission Page" class="link-logo float-right" src="res/img/ld.png"></a>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $('.game-link').on('mouseover', function(e){
        $(this).children('.game-information').stop(true);
        $(this).children('.game-information').animate({height: 245}, 500);
    });
